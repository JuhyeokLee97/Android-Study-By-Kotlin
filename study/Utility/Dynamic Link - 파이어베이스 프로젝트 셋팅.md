...
프로젝트 셋팅이 귀찮을 수도 있겠지만, 제가 포스팅하던 날을 기준으로 셋팅하는 방법을 이미지 하나 하나 첨부해서 설명되어있으니 천천히 따라해주시면 금방 마무리 될 것입니다~!</br>
저도 처음에 귀찮아서 잘 정리되어 있는 블로그를 참고하여 하려고 여기저기 짧은 블로그를 찾아 다녔지만, 그냥 하나 잡고 잘 따라하면 되더라구요~~ :) 
...
위 화면에서 빨깐색 네모 <strong>[프로젝트 추가]</strong>를 클릭하셔서 프로젝트를 생성하실 수 있습니다.
...
<p>
  ...
  <img width=700
       src="https://user-images.githubusercontent.com/40654227/226353413-242ca49d-ea3c-4383-ae09-0d3dd3d04c77.png"/>
  

  <strong>이렇게 프로젝트 셋팅까지 마무리하면 DynamicLink를 구현할 준비가 완료가 된 것입니다!!</strong>
  
  간단하지만 귀찮은(?) 작업을 잘 마무리 하셨다면 이제 DynamicLink를 생성하고, 생성한 DynamicLink를 통해서 앱에서 DeepLink를 처리하는 것을 학습하도록 하겠습니다.
</p>
